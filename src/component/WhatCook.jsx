function WhatCook() {
  return (
    <>
      <div
        className="flex flex-col justify-center items-center px-10 py-16"
        data-aos="fade-up"
      ...
      >
        ...
        >
          What to <span className="text-orange-500">Cook</span>
        </h1>

        <ul
          className="flex flex-wrap space-y-2 space-x-4 mt-14"
          data-aos="fade-right"
          data-aos-duration="1000"
        >
        ...
        <ul
          className="flex flex-wrap space-y-2 space-x-4 mt-4"
          data-aos="fade-left"
          data-aos-duration="1000"
        >
          <li className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-center hover:bg-gray-200 transition cursor-pointer">
